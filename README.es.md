...
| Estado | Zustand 5 (13 stores: model, scene, validation, editor, ui, takeoff, toast, bcf, ids, geo, waiver, capture, presentation) |
...
**Antes de abrir un PR:** ejecuta `npm test` y `npx tsc -b`.
