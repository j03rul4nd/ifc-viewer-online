// ─── DecryptedText ────────────────────────────────────────────────────────────
// React Bits DecryptedText — scrambles characters then progressively reveals
// the real text, triggered on hover / click / view / inViewHover.
//
// Dependencies: framer-motion (already in package.json as framer-motion)
// Note: original source imports from 'motion/react'; we use 'framer-motion'
//       which exports identical APIs.  HTMLMotionProps is not re-exported from
//       framer-motion v11; replaced with React.HTMLAttributes<HTMLSpanElement>.
//
// Usage:
//   <DecryptedText text="FEATURES" animateOn="view" />
//   <DecryptedText text="Hover me" animateOn="hover" sequential revealDirection="start" />
...
export default function DecryptedText({
  ...
  // Initial state based on animateOn
  useEffect(() => {
    if (animateOn === 'click') {
      encryptInstantly()
    } else {
