...
export const DEMO_MODELS: DemoModel[] = [
  {
    ...
    description:
      '468 m, 11 pearls, hollow support tubes, interior detail and mapped museum footprint. Approximate reconstruction with museum, hotel, observation decks and restaurant across 25 reference levels; not as-built.',
    category: 'Commercial',
    fileName: 'SHA-IVO-ORIENTAL-PEARL-A-0001.ifc',
    ifcUrl: `${import.meta.env.BASE_URL}models/oriental-pearl/SHA-IVO-ORIENTAL-PEARL-A-0001.ifc?v=20260906-r2`,
    ...
    schema: 'IFC4',
    approximateSize: '21.2 MB',
    sizeBytes: 22_227_275,
  ...
  },
  {
    ...
    ifcUrl: `${import.meta.env.BASE_URL}models/swfc/SHA-IVO-SWFC-A-0001.ifc?v=20260906-r2`,
