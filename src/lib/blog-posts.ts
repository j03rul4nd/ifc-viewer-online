...
export interface BlogPost {
  ...
  lang?: string
  /**
   * The title a SEARCH RESULT shows, when the article's own title is too long
   * for one.
   *
   * Google renders about 60 characters. 25 of these posts have editorial
   * titles past that — "Solibri Alternative in 2026: When Browser-Based IFC
   * Validation Is Enough (And When It Is Not)" is 93 — so the listing showed a
   * headline chopped before its payoff.
   *
   * Shortening `title` would shorten the H1 and the index card with it, which
   * is a worse trade: on the page there is room for the nuance, in a listing
   * there is not. So the two are allowed to differ, and the article keeps its
   * writing. Optional — omit it and `title` is used.
   */
  seoTitle?: string
  /**
   * The description a search result shows, when the excerpt is too long.
   *
   * `excerpt` is on-page copy: it is also the blog index card. Reusing it as a
   * meta description is the same mistake the home pages made with their hero
   * copy — 43 of these run past the ~160 Google renders, median 216. Optional;
   * omit it and `excerpt` is used.
   */
...
export const BLOG_POSTS: BlogPost[] = [
...

  {
    ...
    seoDescription: 'You are 20 minutes from a client call and just received a 200 MB IFC. No Revit, no Navisworks. How to open, inspect and validate it before the call ends.',
    date: '2026-06-02',
    readTimeMin: 6,
    ...
    content: [
      ...
      { type: 'p', text: "This viewer parses IFC files entirely in your browser using WebAssembly. Your geometry never leaves your device. You can open a 200 MB file on an airplane with Wi-Fi off." },
      {
        ...
        items: [
          ...
          { icon: '📐', title: '44 validation rules', body: "From duplicate GUIDs to spatial hierarchy violations — every major IFC quality issue surfaced in under 30 seconds." },
        ],
      },
...

  {
    ...
    seoDescription: 'Your BEP says “deliver a quality IFC”. Nobody defines what that means until the model is rejected. A Health Score turns it into a number you can track.',
    date: '2026-05-28',
    readTimeMin: 7,
    ...
    content: [
      ...
      { type: 'p', text: "A Health Score changes that. It's a single 0–100 number calculated automatically against 44 validation rules. It's the same number every time, on every machine, on every version of the model. It belongs in your BEP as a hard deliverable requirement." },
...

  {
    ...
    seoTitle: 'Duplicate GUIDs in IFC: The Silent Error That Breaks It',
    seoDescription: 'Your BCF comments reference elements that have vanished. The model looks fine. The cause: two elements sharing one GlobalId, confusing every tool after it.',
    date: '2026-05-20',
    readTimeMin: 8,
    category: 'Validation',
...
// Both elements share the same GlobalId — IFC schema violation.`,
...

  {
    ...
    seoTitle: 'IFC, RVT, NWD or DWG: Which Should You Deliver?',
    seoDescription: 'Structural delivers RVT, MEP uses NWD, the client wants IFC and the PM asks for DWG. How to navigate the format maze, and why open BIM matters.',
    date: '2026-05-10',
    readTimeMin: 9,
    category: 'IFC Tips',
...

  {
    ...
    seoTitle: 'The 7 Most Common IFC Validation Errors, and the Fixes',
    seoDescription: 'Duplicate GUIDs, orphan elements and broken spatial hierarchies cause over 80% of IFC delivery rejections. How to spot and fix each before the CDE sees it.',
    date: '2026-05-05',
    readTimeMin: 8,
    category: 'Validation',
    categorySlug: 'validation',
...

  {
    ...
    seoTitle: 'How to Export Clean IFC Files from Revit, Step by Step',
    seoDescription: 'Revit’s default IFC export settings produce avoidable validation warnings by the dozen. The exact settings that eliminate the most common failures.',
    date: '2026-04-10',
    readTimeMin: 7,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...

  {
    ...
    seoDescription: 'Most projects still deliver IFC2x3 though IFC4 has been the ISO standard since 2018. What changes, when to upgrade, and how to avoid breaking your tools.',
    date: '2026-03-28',
    readTimeMin: 6,
    category: 'IFC Tips',
    categorySlug: 'ifc-tips',
...

  {
    ...
    seoTitle: 'ISO 19650 for IFC Deliveries: A Practical Checklist',
    seoDescription: 'What ISO 19650 information requirements mean for your IFC files — from filename conventions to embedded metadata — and how to verify them before you send.',
    date: '2026-03-15',
    readTimeMin: 9,
    category: 'Standards',
...

  {
    ...
    seoTitle: 'Why IFC GUIDs Change on Every Export, and How to Stop It',
    seoDescription: 'You re-export the model and every BCF comment, clash and FM tag points at the wrong element. Your GlobalIds were regenerated. Why, and how to lock them.',
    date: '2026-06-03',
    readTimeMin: 8,
    category: 'Validation',
    categorySlug: 'validation',
...
#1402 = IFCWALL('2hQ8pZ_a1ABxKm9dELc0Ru', $, 'Exterior Wall - 300mm', ...);`,
...

  {
    ...
    seoTitle: 'IFC Properties Missing After a Revit Export? The Fixes',
    seoDescription: 'You exported the model and half your parameters are gone — or they vanished only for a colleague. The checklist that explains why, and gets them across.',
    date: '2026-06-03',
    readTimeMin: 8,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...

  {
    ...
    seoTitle: 'How to Validate an IFC File Before You Send It',
    seoDescription: 'Three real ways to validate an IFC before you send it — buildingSMART, IfcOpenShell and an in-browser health check — and what each one actually catches.',
    date: '2026-06-03',
...
python validate_and_score.py model.ifc`,
...

  {
    ...
    seoTitle: 'Why Large IFC Files Crash Your Browser (and the Fix)',
    seoDescription: 'A 600 MB federated IFC, 1.7 GB of RAM, 3 frames per second, then the tab dies. Why large IFC files break web viewers, and how to open one anyway.',
    date: '2026-06-03',
    readTimeMin: 9,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...

  {
    ...
    seoDescription: 'Elements on the wrong floor, walls missing, the model in the wrong place. Revit IFC exports break for a handful of predictable reasons. Which one bit you.',
    date: '2026-06-03',
    readTimeMin: 9,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...

  {
    ...
    seoDescription: 'Every BEP demands a “quality IFC” and almost none define it. The failure categories that get models rejected, how to check each, and a repeatable workflow.',
    date: '2026-06-03',
    readTimeMin: 12,
    category: 'BIM Best Practices',
    categorySlug: 'best-practices',
...

  {
    ...
    seoTitle: 'IFC Coordinates Are Wrong: Survey Point & Georeferencing',
    seoDescription: 'The building imports two kilometres away, or sits at the origin when it should be on a national grid. Why Revit and IFC disagree, and how to fix it.',
    date: '2026-06-03',
    readTimeMin: 9,
    category: 'IFC Tips',
    categorySlug: 'ifc-tips',
...

  {
    ...
    seoTitle: 'Revit ↔ Archicad via IFC: The Round-Trip Problems',
    seoDescription: 'An Archicad IFC linked into Revit shows duplicate geometry floating in the air, though the same file looks perfect elsewhere. What breaks between vendors.',
    date: '2026-06-03',
    readTimeMin: 8,
    category: 'IFC Tips',
    categorySlug: 'ifc-tips',
...

  {
    ...
    seoTitle: 'Free Online IFC Viewers Compared (2026): Privacy & Limits',
    seoDescription: 'A dozen free browser IFC viewers, with very different trade-offs: some upload your file, some cap at 10 MB, some never validate. An honest comparison.',
    date: '2026-06-03',
    readTimeMin: 8,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...

  {
    ...
    seoDescription: 'A 900 MB IFC will not email and crashes the coordinator’s viewer. You can usually cut 70–90%, but only some methods are safe for the data downstream.',
    date: '2026-06-03',
    readTimeMin: 7,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...

  {
    ...
    seoDescription: 'Pull quantities, classifications and custom Psets out of an IFC with IfcOpenShell — a practical Python cookbook, including the get_psets shortcut.',
    date: '2026-06-03',
    readTimeMin: 8,
    category: 'IFC Tips',
    categorySlug: 'ifc-tips',
...
with open("elements.csv", "w", newline="") as f:
...

  {
    ...
    seoTitle: 'View IFC in the Browser with three.js and web-ifc',
    seoDescription: 'Loading an IFC into three.js is simple until a 200 MB model freezes the tab. The trick: do not parse IFC at runtime. How the pieces fit together.',
    date: '2026-06-03',
    readTimeMin: 9,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...
fragments.load(cached);            // fast`,
...

  {
    ...
    seoTitle: 'Online IFC Viewer with Confidential Project Data?',
    seoDescription: 'Your NDA does not care which software you use. The technical test that tells you, in 30 seconds, whether a sensitive IFC stays on your machine.',
    date: '2026-06-04',
    readTimeMin: 7,
...

  {
    ...
    seoTitle: 'GDPR and BIM Data: What Project Managers Need to Know',
    seoDescription: 'IFC files can contain personal data under GDPR, and sharing a model via a cloud tool creates obligations with legal teeth. What EU teams need to know.',
    date: '2026-06-04',
    readTimeMin: 9,
    category: 'Best Practices',
    categorySlug: 'best-practices',
...

  {
    ...
    seoTitle: 'BIM Tool IT Security Checklist: 10 Questions IT Will Ask',
    seoDescription: 'IT will ask about data residency, encryption, GDPR, sub-processors and source auditability. The 10 standard questions, and how this tool answers each.',
    date: '2026-06-04',
    readTimeMin: 8,
    category: 'Best Practices',
    categorySlug: 'best-practices',
...

  {
    ...
    seoDescription: 'Most BEPs say models must be “of suitable quality” and nothing else, which is why quality arguments never end. Four short clauses, written to be pasted.',
    date: '2026-08-07',
    readTimeMin: 9,
    category: 'Standards',
    categorySlug: 'standards',
...

  {
    ...
    seoTitle: 'IFC Acceptance Criteria: Accept or Reject Without a Row',
    seoDescription: '“This model is unusable” versus “the model is fine” is an argument with no ending. A one-page acceptance table turns it into a five-minute check.',
    date: '2026-08-07',
    readTimeMin: 10,
    category: 'Standards',
    categorySlug: 'standards',
...

  {
    ...
    seoDescription: 'A delivery is a claim: this model is fit for this purpose at this revision. Evidence is what lets the receiver check it without repeating your work.',
    date: '2026-08-07',
    readTimeMin: 9,
    category: 'Best Practices',
    categorySlug: 'best-practices',
...

  {
    ...
    seoTitle: 'Free Online IFC Editor: Edit Properties Without Revit',
    seoDescription: 'Edit IFC properties free in your browser — nothing uploaded, no Revit needed. An honest guide to Revit, ArchiCAD, Solibri and BIMVision too.',
    date: '2026-06-28',
    readTimeMin: 11,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...
<script type="module">
...

  {
    ...
    seoTitle: 'IFC Model Checker: The Complete Guide to IFC Validation',
    seoDescription: 'Schema, model quality (44 rules + Health Score) and IDS are three independent layers. Confusing them causes delivery failures. The full breakdown.',
    date: '2026-06-28',
    readTimeMin: 20,
    category: 'Validation',
    categorySlug: 'validation',
...
`,
...

  {
    ...
    seoTitle: 'IFC Health Score: The Definitive Guide for Coordinators',
    seoDescription: 'A Health Score is not a percentage, it is a decision-making tool. How it is calculated, what each band means, and how to set thresholds in the BEP.',
    date: '2026-06-28',
    readTimeMin: 22,
    category: 'BIM Best Practices',
    categorySlug: 'best-practices',
...
── BEP clause (operational, implementation plan) ─────────────────────────────
...

  {
    ...
    seoTitle: 'Browser vs Cloud IFC Validation: The Architecture Decision',
    seoDescription: 'Offline IFC validation via WebAssembly — nothing uploaded, works on site. Browser vs cloud: privacy, GDPR, upload speed, and when each one wins.',
    date: '2026-06-28',
    readTimeMin: 19,
    category: 'Validation',
    categorySlug: 'validation',
...
══════════════════════════════════════════
...

  {
    ...
    seoDescription: 'There is no single best IFC viewer — the right choice depends on your workflow. Ten tools compared on validation depth, BCF, IDS, privacy and file size.',
    date: '2026-06-30',
    readTimeMin: 24,
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
...

  {
    ...
    seoTitle: 'Solibri Alternative: When Browser IFC Validation Is Enough',
    seoDescription: 'Solibri is one of the strongest BIM quality platforms, and not every IFC workflow needs its full weight. An honest comparison, and how to decide.',
    date: '2026-06-30',
    readTimeMin: 22,
    category: 'Validation',
    categorySlug: 'validation',
...
Client / FM handover`,
  ...
  // ── Article #8: IFC Model Checker vs IFC Viewer ───────────────────────────
  {
    ...
    seoDescription: 'Checkers validate data against rules and produce a score. Viewers render geometry and browse properties. How to know which your workflow needs.',
    date: '2026-06-30',
    author: 'IFC Viewer Online',
    category: 'Validation',
    categorySlug: 'validation',
...
└─ All of the above in one workflow
  ...
  // ── Article #9: Best IFC Model Checkers in 2026 ───────────────────────────
  {
    ...
    seoDescription: 'An independent comparison of eight tools on actual checking depth, not marketing claims — with a capability table and an honest workflow fit guide.',
    date: '2026-06-30',
    author: 'IFC Viewer Online',
    category: 'Tool Guides',
    categorySlug: 'tool-guides',
  ...
  // ── Article #10: How to Check an IFC Model Before Delivery ───────────────
  {
    ...
    seoDescription: 'A practical workflow for BIM coordinators: export, schema check, quality check, fix, IDS validation, archive the report. With a checklist per stage.',
    date: '2026-06-30',
    author: 'IFC Viewer Online',
    category: 'Validation',
    categorySlug: 'validation',
...
Archive report → Upload to CDE`,
  ...
  // ── Article #11: 10 Common IFC Model Errors ───────────────────────────────
  {
    ...
    seoDescription: 'The ten errors that appear most often in IFC files delivered on real projects — what causes them, how a checker detects them, and how to fix the source.',
    date: '2026-06-30',
    author: 'IFC Viewer Online',
    category: 'Validation',
    categorySlug: 'validation',
...

  {
    ...
    title: 'IFC Point Cloud Viewer: Real Scan-to-BIM Case + Browser Demo',
    excerpt: 'See a real CRAS TLS-to-IFC alignment, inspect sections and launch an interactive IFC + LAS browser demo with no model upload.',
    date: '2026-08-21',
    ...
    heroAlt: 'Cover titled IFC Point Cloud Viewer over a real CRAS Labs TLS point cloud aligned with its IFC model',
    heroImageVariants: [
    ...
    content: [
      ...
      { type: 'p', text: 'Start the example to load a lightweight IFC4 pavilion and its matching LAS survey in the real viewer. Orbit the scene, inspect the overlay and open the full viewer if you want the complete point-cloud controls. This pair is synthetic and uses a shared ETRS89 / UTM 31N reference; it demonstrates the workflow, not the accuracy of a physical instrument.' },
      {
        ...
        posterAlt: 'Real CRAS TLS point cloud aligned with its IFC model, used as the preview for the interactive workflow',
...

  {
    ...
    title: 'Real-Time LiDAR + IFC in the Browser: MCAP Replay Demo',
    excerpt: 'Run the actual web replay interface and learn the bounded buffers, binary frames and telemetry behind an honestly labelled simulated IFC + LiDAR stream.',
    date: '2026-08-21',
    dateModified: '2026-08-21',
    readTimeMin: 12,
    category: 'Digital Twins',
    ...
    heroAlt: 'Cover titled Real-Time LiDAR and IFC over an actual viewer capture showing the simulated temporal replay aligned with a pavilion',
    heroImageVariants: [
    ...
    content: [
      ...
      { type: 'p', text: 'The following live example generates a deterministic scan front around the matching IFC pavilion. The same frame passes through binary encoding, CRC validation and a fixed three-slot transport buffer before it reaches the GPU. Switch to the full viewer to inject deterministic loss, reordering, corruption and a reconnect window.' },
      {
        ...
        posterAlt: 'Actual IFC Viewer Online interface showing a simulated temporal LiDAR replay aligned with the Operations Pavilion IFC',
      ...
      },
      {
        ...
        alt: 'IFC Viewer Online displaying a simulated temporal LiDAR scan over the Operations Pavilion IFC with replay and alignment telemetry visible',
        caption: 'Actual product capture: the temporal source is a deterministic simulated replay, while parsing, buffering, GPU updates and IFC alignment run in the real viewer.',
        width: 1440,
        height: 900,
...

  {
    ...
    title: 'IFC + Video on 3D Terrain: Interactive Construction Demo',
    excerpt: 'See the actual viewer place video beside IFC as a screen, terrain overlay or billboard, then try metric position and opacity in the browser demo.',
    date: '2026-08-21',
    dateModified: '2026-08-21',
    readTimeMin: 10,
    category: 'Digital Twins',
    ...
    heroAlt: 'Cover titled IFC and Video on 3D Terrain over an actual viewer capture with the Operations Pavilion and video placement controls',
    heroImageVariants: [
      ...
      { src: 'blog/images/ifc-video-3d-terrain-construction-progress-1200x1200.jpg', width: 1200, height: 1200 },
    ],
    ...
    content: [
      ...
      { type: 'p', text: 'Start the live example to load the exact IFC companion, create one video texture and frame both resources together. The clip begins muted and loops locally, so the demo does not depend on a streaming service or exhibition Wi-Fi.' },
      {
        ...
        posterAlt: 'Actual IFC Viewer Online interface showing the pavilion, the video billboard and metric position, size and opacity controls',
      ...
      },
      {
        ...
        alt: 'IFC Viewer Online showing the Operations Pavilion, a video billboard and controls for screen, terrain, position, width and opacity',
        caption: 'Actual product capture: the bundled IFC and MP4 are loaded together and the video surface can be positioned, resized and made transparent.',
        width: 1440,
        height: 900,
        credit: 'IFC Viewer Online · actual application capture',
      },
...

  {
    ...
    title: 'How to View an IFC on a 3D Map: Georeferenced BIM in the Browser',
    seoTitle: 'View IFC on a 3D Map Online | Georeferenced BIM',
    excerpt: 'Open a real IFC4 pavilion in its Barcelona map context, inspect the live 3D demo, and learn how IfcProjectedCRS and IfcMapConversion place BIM correctly.',
    seoDescription: 'View an IFC on a 3D map online. Try a live georeferenced BIM demo and learn how IfcMapConversion aligns a model with terrain and GIS context.',
    date: '2026-08-27',
    ...
    heroAlt: 'Actual IFC Viewer Online capture showing the georeferenced Ciutadella Pavilion inside a detailed 3D map of Barcelona',
    heroCredit: 'IFC Viewer Online · OpenStreetMap contributors (ODbL) · terrain attribution visible in viewer',
    keywords: ['view IFC on 3D map', 'IFC GIS viewer', 'georeferenced IFC viewer', 'IfcMapConversion', 'BIM 3D map online', 'IFC terrain viewer'],
    faqs: [
      { q: 'Can I view my own IFC file on a 3D map?', a: 'Yes. Open the IFC in the browser and enable Map mode. A georeferenced IFC can be placed automatically; a file without usable location data can be positioned manually with a map pin.' },
      { q: 'What IFC data provides accurate map placement?', a: 'For IFC4, the strongest route is an IfcProjectedCRS identifying the target coordinate reference system plus IfcMapConversion values for eastings, northings, height, rotation and scale.' },
      { q: 'Is IfcSite latitude and longitude enough?', a: 'It can provide an approximate fallback, but it normally does not carry the same projected-coordinate precision, rotation and vertical reference as a complete map conversion.' },
      { q: 'Does Map mode upload the IFC file?', a: 'The IFC is parsed locally in the browser. Map mode still needs network requests for the selected map, terrain and OpenStreetMap context, so it is not an offline feature.' },
      { q: 'Which coordinate system does the Ciutadella example use?', a: 'The included IFC4 file names EPSG:25831, ETRS89 / UTM zone 31N, and includes a real IfcMapConversion aligned to the Passeig de Lluís Companys axis.' },
    ],
    content: [
      { type: 'p', text: ['Yes: you can view an IFC on a 3D map directly in the browser. The useful version of that sentence is not “put a building near a pin”; it is “read the model coordinate reference system, preserve the engineering geometry, and align terrain plus GIS context around it”. The live example below does exactly that with a small IFC4 pavilion in Barcelona.'] },
      {
        type: 'stat-row',
        stats: [
          { value: 4, suffix: '', label: 'IFC schema' },
          { value: 240, suffix: ' KB', label: 'example file' },
          { value: 137, suffix: '', label: 'model elements' },
          { value: 25831, prefix: 'EPSG:', label: 'projected CRS' },
        ],
      },
      {
        type: 'image',
        src: 'blog/images/ifc-3d-map-ciutadella-real-viewer.jpg',
        alt: 'Actual IFC Viewer Online map mode with the small Ciutadella Pavilion highlighted among extruded Barcelona buildings, tree-lined avenues and terrain',
        caption: 'Actual product capture from the reproducible deep link. The pavilion is the authored IFC; the city, terrain and trees are surrounding map context.',
        width: 1600,
        height: 900,
        credit: 'IFC Viewer Online · OpenStreetMap contributors (ODbL) · terrain attribution visible in viewer',
      },
      { type: 'h2', text: 'Try the IFC + 3D Map Demo' },
      { type: 'p', text: 'Start the example to load the bundled IFC locally and then request its 3D site context. Orbit, zoom and open the full viewer if you want the complete map controls. External map services can take a few seconds to stream terrain and surrounding features.' },
      {
        type: 'spatial-demo',
        demo: 'ciutadella-map-3d',
        title: 'Ciutadella Pavilion — georeferenced IFC on a 3D map',
        description: 'A bundled 240 KB IFC4 model aligned automatically in Barcelona through EPSG:25831 and IfcMapConversion, with optional terrain and OpenStreetMap surroundings.',
        poster: 'blog/images/ifc-3d-map-ciutadella-real-viewer.jpg',
        posterAlt: 'Actual IFC Viewer Online capture of the Ciutadella Pavilion loaded in Barcelona map mode',
        launchLabel: 'Load the live IFC + 3D map',
        readyLabel: 'IFC and map are ready — drag to orbit',
        height: 560,
      },
      { type: 'h2', text: 'What Makes a Map Placement Trustworthy?' },
      { type: 'p', text: ['The official buildingSMART definition says ', { text: 'IfcMapConversion', href: 'https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/IfcMapConversion.htm' }, ' transforms a local engineering coordinate system into the coordinate reference system of the map using scale, rotation and translation. ', { text: 'IfcProjectedCRS', href: 'https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/IfcProjectedCRS.htm' }, ' identifies that map coordinate system. Those two pieces answer different questions and are both useful.'] },
      {
        type: 'table',
        headers: ['IFC information', 'Question it answers', 'Confidence in this workflow'],
        rows: [
        ...
        caption: 'Opening successfully is not evidence that an IFC is located correctly. The placement source must remain visible.',
      },
      {
        type: 'image',
        src: 'blog/images/ifc-map-georeferencing-flow.svg',
        alt: 'Diagram showing local IFC coordinates transformed by IfcProjectedCRS and IfcMapConversion into aligned terrain and 3D map context',
        caption: 'The map aligns around the local model. Keeping geometry near the project origin avoids sacrificing rendering precision to very large global coordinates.',
        width: 1600,
        height: 900,
        credit: 'IFC Viewer Online',
      },
      ...
      { type: 'p', text: ['The model and its ', { text: 'Blender/Bonsai generation script', href: 'https://github.com/j03rul4nd/ifc-viewer-online/blob/main/scripts/blender/build-ciutadella.py' }, ' are public, so the screenshot and live scene can be rebuilt instead of taken on trust.'] },
      { type: 'h2', text: 'What the 3D Map Adds to an IFC Viewer' },
      {
        type: 'feature-grid',
        items: [
          { icon: '🧭', title: 'Orientation you can verify', body: 'Street axes and neighbouring geometry reveal a wrong north angle immediately.' },
          { icon: '⛰️', title: 'Terrain context', body: 'Relief gives the model a ground reference while a height offset handles datum differences explicitly.' },
          { icon: '🏙️', title: 'Surrounding massing', body: 'OpenStreetMap buildings, water, parks, trees and bridges provide site context without becoming IFC elements.' },
          { icon: '📐', title: 'Engineering coordinates preserved', body: 'The model remains in its local metre-based frame; the basemap moves into the scene rather than rewriting the IFC geometry.' },
        ],
      },
      ...
      { type: 'h2', text: 'Local IFC Privacy and Online Map Requests Are Separate' },
      {
        type: 'comparison',
        left: {
          label: 'IFC processing',
          color: 'accent',
          items: ['File bytes parsed in the browser', 'Geometry stays on the device', 'Local project coordinates preserved', 'Works without creating an account'],
        },
        right: {
          label: 'Map context',
          color: 'neutral',
          items: ['Downloads tiles or terrain from the selected provider', 'Requests OpenStreetMap surroundings when enabled', 'Requires provider attribution', 'Needs network access and provider availability'],
        },
      },
      { type: 'p', text: ['OpenStreetMap requires visible credit and notice of its ODbL terms. The viewer keeps that attribution inside map captures; the ', { text: 'official OpenStreetMap copyright page', href: 'https://www.openstreetmap.org/copyright' }, ' explains the requirement. Hiding the attribution to make a cleaner marketing image would make the image less trustworthy and non-compliant.'] },
      { type: 'h2', text: 'How to Put Your Own IFC on a 3D Map' },
      { type: 'ol', items: [
      ...
      { type: 'h2', text: 'The Visual Promise — and Its Limit' },
      {
        type: 'image',
        src: 'blog/images/ifc-3d-map-conceptual-editorial.jpg',
        alt: 'Conceptual editorial rendering of a translucent BIM building aligned over a Mediterranean city grid at sunset',
        caption: 'Conceptual editorial illustration generated for this article. It communicates the IFC + GIS idea; it is not a product screenshot, survey or representation of the Ciutadella Pavilion.',
        width: 1600,
        height: 900,
        credit: 'IFC Viewer Online · AI-generated conceptual illustration',
      },
      { type: 'pull-quote', text: 'A convincing 3D map is useful. A visible coordinate source, confidence level and reproducible model are what make it authoritative.', cite: 'IFC Viewer Online' },
      { type: 'p', text: ['For measured reality beside the model, continue with ', { text: 'IFC + point-cloud Scan-to-BIM alignment', to: 'ifc-point-cloud-browser-scan-to-bim' }, '. For time-based site evidence, see ', { text: 'IFC + video on 3D terrain', to: 'ifc-video-3d-terrain-construction-progress' }, '.'] },
    ],
  },
...
export const BLOG_POSTS_ES: BlogPost[] = [
...

  {
    ...
    seoDescription: 'GUIDs duplicados, elementos huérfanos y jerarquías rotas causan más del 80% de los rechazos en el ECD. Cómo detectar y corregir cada uno a tiempo.',
    date: '2026-05-12',
    readTimeMin: 7,
    category: 'Validación',
    categorySlug: 'validation',
...

  {
    ...
    seoDescription: 'El estructurista entrega RVT, el instalador NWD, el cliente pide IFC y el jefe de proyecto DWG. Cómo navegar el laberinto y por qué importa el BIM abierto.',
    date: '2026-05-02',
    readTimeMin: 7,
...

  {
    ...
    translationKey: 'ifc-point-cloud-scan-to-bim',
    title: 'Visor IFC + nube de puntos: caso Scan-to-BIM real y demo web',
    excerpt: 'Observa la alineación TLS–IFC real de CRAS, compara secciones y abre una demo interactiva IFC + LAS sin subir el modelo a ningún servidor.',
    date: '2026-08-21',
    dateModified: '2026-08-21',
    readTimeMin: 11,
    category: 'Gemelos digitales',
    ...
    author: 'IFC Viewer Team',
    lang: 'es',
    heroImage: 'blog/images/ifc-nube-de-puntos-scan-to-bim-navegador-1600x900.jpg',
    heroAlt: 'Cover titulada Visor IFC más nube de puntos sobre la nube TLS real de CRAS Labs alineada con su modelo IFC',
    heroImageVariants: [
      { src: 'blog/images/ifc-nube-de-puntos-scan-to-bim-navegador-1600x900.jpg', width: 1600, height: 900 },
      { src: 'blog/images/ifc-nube-de-puntos-scan-to-bim-navegador-1200x900.jpg', width: 1200, height: 900 },
      { src: 'blog/images/ifc-nube-de-puntos-scan-to-bim-navegador-1200x1200.jpg', width: 1200, height: 1200 },
    ],
    ...
    content: [
      ...
      { type: 'h2', text: 'Prueba IFC + nube de puntos en vivo' },
      {
        ...
        poster: 'blog/images/ifc-nube-de-puntos-scan-to-bim-navegador-800x450.jpg',
        posterAlt: 'Nube TLS real de CRAS alineada con su IFC, utilizada como vista previa del flujo interactivo',
...

  {
    ...
    translationKey: 'real-time-lidar-web-mcap',
    title: 'LiDAR en tiempo real + IFC: demo web con replay MCAP',
    excerpt: 'Abre la interfaz real de replay y entiende los frames binarios, buffers acotados y telemetría de un flujo IFC + LiDAR claramente marcado como simulado.',
    date: '2026-08-21',
    dateModified: '2026-08-21',
    readTimeMin: 12,
    category: 'Gemelos digitales',
    ...
    author: 'IFC Viewer Team',
    lang: 'es',
    heroImage: 'blog/images/lidar-tiempo-real-web-gemelo-digital-mcap-1600x900.jpg',
    heroAlt: 'Cover titulada LiDAR en tiempo real más IFC sobre una captura real del visor con el replay temporal simulado alineado al pabellón',
    heroImageVariants: [
      { src: 'blog/images/lidar-tiempo-real-web-gemelo-digital-mcap-1600x900.jpg', width: 1600, height: 900 },
      { src: 'blog/images/lidar-tiempo-real-web-gemelo-digital-mcap-1200x900.jpg', width: 1200, height: 900 },
      { src: 'blog/images/lidar-tiempo-real-web-gemelo-digital-mcap-1200x1200.jpg', width: 1200, height: 1200 },
    ],
    ...
    content: [
      ...
      { type: 'h2', text: 'Prueba el replay temporal IFC + LiDAR' },
      {
        ...
        poster: 'blog/images/ifc-lidar-temporal-replay-real-viewer.png',
        posterAlt: 'Interfaz real de IFC Viewer Online mostrando el replay LiDAR temporal simulado y alineado con el IFC del pabellón',
      ...
      },
      {
        type: 'image',
        src: 'blog/images/ifc-lidar-temporal-replay-real-viewer.png',
        alt: 'IFC Viewer Online mostrando un escaneo LiDAR temporal simulado sobre el IFC del pabellón con telemetría de replay y alineación',
        caption: 'Captura real del producto: la fuente temporal es simulada y determinista; parser, buffer, actualización GPU y alineación IFC funcionan en el visor real.',
        width: 1440,
        height: 900,
        credit: 'IFC Viewer Online · captura real de la aplicación',
      },
...

  {
    ...
    translationKey: 'ifc-video-3d-terrain',
    title: 'IFC + vídeo sobre terreno 3D: demo de seguimiento de obra',
    excerpt: 'Mira el visor real colocando vídeo como pantalla, terreno o billboard junto al IFC y prueba posición métrica, tamaño y opacidad en la demo web.',
    date: '2026-08-21',
    dateModified: '2026-08-21',
    readTimeMin: 10,
    category: 'Gemelos digitales',
    ...
    author: 'IFC Viewer Team',
    lang: 'es',
    heroImage: 'blog/images/ifc-video-terreno-3d-seguimiento-obra-1600x900.jpg',
    heroAlt: 'Cover titulada IFC más vídeo sobre terreno 3D creada con una captura real del visor, el pabellón y sus controles de colocación',
    heroImageVariants: [
      { src: 'blog/images/ifc-video-terreno-3d-seguimiento-obra-1600x900.jpg', width: 1600, height: 900 },
      { src: 'blog/images/ifc-video-terreno-3d-seguimiento-obra-1200x900.jpg', width: 1200, height: 900 },
      { src: 'blog/images/ifc-video-terreno-3d-seguimiento-obra-1200x1200.jpg', width: 1200, height: 1200 },
    ],
    ...
    content: [
      ...
      { type: 'h2', text: 'Prueba IFC + vídeo 3D en vivo' },
      {
        ...
        poster: 'blog/images/ifc-video-3d-placement-controls-real-viewer.png',
        posterAlt: 'Interfaz real de IFC Viewer Online con el pabellón, el billboard de vídeo y controles métricos de posición, tamaño y opacidad',
      ...
      },
      {
        type: 'image',
        src: 'blog/images/ifc-video-3d-placement-controls-real-viewer.png',
        alt: 'IFC Viewer Online mostrando el pabellón de operaciones, un billboard de vídeo y controles de pantalla, terreno, posición, anchura y opacidad',
        caption: 'Captura real del producto: el IFC y el MP4 incluidos están cargados juntos y la superficie de vídeo se puede colocar, escalar y transparentar.',
        width: 1440,
        height: 900,
        credit: 'IFC Viewer Online · captura real de la aplicación',
      },
  ...
  {
    slug: 'ver-ifc-mapa-3d-online',
    translationKey: 'ifc-3d-map-georeferenced',
    title: 'Cómo ver un IFC en un mapa 3D: BIM georreferenciado en el navegador',
    seoTitle: 'Ver un IFC en un mapa 3D online | BIM georreferenciado',
    excerpt: 'Abre un pabellón IFC4 real dentro de su contexto 3D de Barcelona, prueba la demo y descubre cómo IfcProjectedCRS e IfcMapConversion colocan el BIM.',
    seoDescription: 'Mira un IFC en un mapa 3D online. Prueba una demo BIM georreferenciada y aprende cómo IfcMapConversion alinea modelo, terreno y contexto GIS.',
    date: '2026-08-27',
    dateModified: '2026-08-27',
    readTimeMin: 10,
    category: 'Guías',
    ...
    lang: 'es',
    heroImage: 'blog/images/ifc-3d-map-ciutadella-real-viewer.jpg',
    heroAlt: 'Captura real de IFC Viewer Online con el Pabellón Ciutadella georreferenciado dentro de un mapa 3D detallado de Barcelona',
    heroCredit: 'IFC Viewer Online · colaboradores de OpenStreetMap (ODbL) · atribución del terreno visible en el visor',
    keywords: ['ver IFC en mapa 3D', 'visor IFC GIS', 'IFC georreferenciado', 'IfcMapConversion', 'BIM mapa 3D online', 'visor IFC terreno'],
    faqs: [
      { q: '¿Puedo ver mi propio archivo IFC sobre un mapa 3D?', a: 'Sí. Abre el IFC en el navegador y activa el modo Mapa. Un IFC georreferenciado puede colocarse automáticamente; si no contiene una ubicación útil, puedes situarlo manualmente con un pin.' },
      { q: '¿Qué datos IFC permiten una colocación precisa?', a: 'En IFC4, la ruta más sólida combina IfcProjectedCRS para identificar el sistema de referencia y los valores de IfcMapConversion para este, norte, altura, rotación y escala.' },
      { q: '¿Basta con la latitud y longitud de IfcSite?', a: 'Sirven como aproximación, pero normalmente no ofrecen la misma precisión proyectada, rotación y referencia vertical que una conversión de mapa completa.' },
      { q: '¿El modo Mapa sube el IFC a un servidor?', a: 'El IFC se procesa localmente en el navegador. El mapa sí realiza peticiones de red para descargar la cartografía, el terreno y el contexto OpenStreetMap seleccionados.' },
      { q: '¿Qué sistema de coordenadas usa el ejemplo de Ciutadella?', a: 'El IFC4 incluido declara EPSG:25831, ETRS89 / UTM zona 31N, y contiene un IfcMapConversion real alineado con el eje del Passeig de Lluís Companys.' },
    ],
    content: [
      { type: 'p', text: 'Sí: puedes ver un IFC en un mapa 3D directamente en el navegador. Pero la versión útil no consiste en dejar un edificio cerca de un pin. Consiste en leer su sistema de referencia, conservar la geometría de ingeniería y alinear alrededor el terreno y el contexto GIS. La demo de este artículo hace exactamente eso con un pequeño IFC4 situado en Barcelona.' },
      {
        type: 'stat-row',
        stats: [
          { value: 4, suffix: '', label: 'esquema IFC' },
          { value: 240, suffix: ' KB', label: 'archivo de ejemplo' },
          { value: 137, suffix: '', label: 'elementos del modelo' },
          { value: 25831, prefix: 'EPSG:', label: 'CRS proyectado' },
        ],
      },
      {
        type: 'image',
        src: 'blog/images/ifc-3d-map-ciutadella-real-viewer.jpg',
        alt: 'Modo mapa real de IFC Viewer Online con el pequeño Pabellón Ciutadella destacado entre edificios 3D, avenidas arboladas y terreno de Barcelona',
        caption: 'Captura real del producto obtenida con el enlace profundo reproducible. El pabellón es el IFC; la ciudad, el terreno y los árboles son contexto cartográfico.',
        width: 1600,
        height: 900,
        credit: 'IFC Viewer Online · colaboradores de OpenStreetMap (ODbL) · atribución del terreno visible en el visor',
      },
      { type: 'h2', text: 'Prueba la demo IFC + mapa 3D' },
      { type: 'p', text: 'Inicia el ejemplo para cargar el IFC incluido localmente y solicitar después su contexto 3D. Puedes orbitar, acercarte y abrir el visor completo. El terreno y los elementos del entorno dependen de servicios externos y pueden tardar unos segundos.' },
      {
        type: 'spatial-demo',
        demo: 'ciutadella-map-3d',
        title: 'Pabellón Ciutadella — IFC georreferenciado en un mapa 3D',
        description: 'Modelo IFC4 de 240 KB colocado automáticamente en Barcelona mediante EPSG:25831 e IfcMapConversion, con terreno y entorno OpenStreetMap opcionales.',
        poster: 'blog/images/ifc-3d-map-ciutadella-real-viewer.jpg',
        posterAlt: 'Captura real del Pabellón Ciutadella cargado en el modo mapa de IFC Viewer Online',
        launchLabel: 'Cargar IFC + mapa 3D en vivo',
        readyLabel: 'IFC y mapa listos — arrastra para orbitar',
        height: 560,
      },
      { type: 'h2', text: 'Qué hace fiable una colocación sobre el mapa' },
      { type: 'p', text: ['Según la definición oficial de buildingSMART, ', { text: 'IfcMapConversion', href: 'https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/IfcMapConversion.htm' }, ' transforma el sistema local de ingeniería al sistema de referencia del mapa mediante escala, rotación y traslación. ', { text: 'IfcProjectedCRS', href: 'https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/IfcProjectedCRS.htm' }, ' identifica ese sistema cartográfico. Son dos piezas distintas y complementarias.'] },
      {
        type: 'table',
        headers: ['Información IFC', 'Pregunta que responde', 'Confianza en este flujo'],
        rows: [
          ['IfcProjectedCRS', '¿Qué cuadrícula proyectada y qué datum?', 'Alta si la definición EPSG se puede resolver'],
          ['IfcMapConversion', '¿Dónde están el origen, la rotación, la altura y la escala?', 'Alta para colocación automática'],
          ['IfcSite RefLatitude / RefLongitude', '¿Dónde está aproximadamente el emplazamiento?', 'Aproximada'],
          ['Pin manual', '¿Dónde quiere mostrar el usuario un modelo sin georreferencia?', 'Aportada por el usuario, no topográfica'],
        ],
        caption: 'Que el archivo se abra no demuestra que esté bien situado. El visor debe mostrar la fuente y la confianza de la colocación.',
      },
      {
        type: 'image',
        src: 'blog/images/ifc-map-georeferencing-flow.svg',
        alt: 'Diagrama del paso de coordenadas IFC locales por IfcProjectedCRS e IfcMapConversion hasta un terreno y mapa 3D alineados',
        caption: 'El mapa se alinea alrededor del modelo local. Mantener la geometría cerca del origen del proyecto evita perder precisión de render por usar coordenadas globales enormes.',
        width: 1600,
        height: 900,
        credit: 'IFC Viewer Online',
      },
      ...
      { type: 'ul', items: [
        'Archivo IFC4 BCN-IVO-ZZ-XX-M3-Z-0003.ifc: 240 KB y 137 elementos del modelo.',
        'CRS de destino: EPSG:25831 — ETRS89 / UTM zona 31N.',
        'Origen cartográfico: E 431543,18; N 4582439,59; altura ortogonal 18,5 m.',
        'Eje X del proyecto: (0,700909; −0,713250), que gira el pabellón aproximadamente −45,5° respecto al este de la cuadrícula.',
        'Emplazamiento: Passeig de Lluís Companys, a unos 80 m del Arc de Triomf y alineado con el paseo, no con el norte de la pantalla.',
      ]},
      {
        type: 'code',
        lang: 'step',
      ...
      { type: 'p', text: ['El modelo y su ', { text: 'script de generación con Blender/Bonsai', href: 'https://github.com/j03rul4nd/ifc-viewer-online/blob/main/scripts/blender/build-ciutadella.py' }, ' son públicos. La escena y la captura pueden reconstruirse en lugar de aceptarse como una promesa de marketing.'] },
      { type: 'h2', text: 'Qué aporta el mapa 3D a un visor IFC' },
      {
        type: 'feature-grid',
        items: [
          { icon: '🧭', title: 'Orientación verificable', body: 'Los ejes de las calles y la geometría vecina delatan enseguida un norte equivocado.' },
          { icon: '⛰️', title: 'Contexto de terreno', body: 'El relieve da una referencia de suelo y el offset de altura hace explícitas las diferencias de datum.' },
          { icon: '🏙️', title: 'Volumetría del entorno', body: 'Edificios, agua, parques, árboles y puentes de OpenStreetMap explican el emplazamiento sin convertirse en elementos IFC.' },
          { icon: '📐', title: 'Coordenadas de ingeniería intactas', body: 'El modelo conserva su marco local en metros; el mapa entra en la escena sin reescribir la geometría IFC.' },
        ],
      },
      ...
      { type: 'h2', text: 'Privacidad local del IFC y peticiones online del mapa son cosas distintas' },
      {
        type: 'comparison',
        left: {
          label: 'Procesamiento IFC',
          color: 'accent',
          items: ['El archivo se analiza en el navegador', 'La geometría permanece en el dispositivo', 'Se conservan las coordenadas locales', 'No hace falta crear una cuenta'],
        },
        right: {
          label: 'Contexto del mapa',
          color: 'neutral',
          items: ['Descarga cartografía o terreno del proveedor elegido', 'Solicita el entorno OpenStreetMap al activarlo', 'Debe mostrar las atribuciones', 'Necesita red y disponibilidad del proveedor'],
        },
      },
      { type: 'p', text: ['OpenStreetMap exige crédito visible y una referencia a sus condiciones ODbL. El visor mantiene la atribución dentro de las capturas; la ', { text: 'página oficial de copyright de OpenStreetMap', href: 'https://www.openstreetmap.org/copyright' }, ' explica el requisito. Ocultarla para conseguir una imagen más limpia reduciría la confianza y no cumpliría la licencia.'] },
      { type: 'h2', text: 'Cómo colocar tu propio IFC en un mapa 3D' },
      { type: 'ol', items: [
        'Abre el IFC en el navegador y revisa sus metadatos de emplazamiento y coordenadas antes de activar capas.',
        'Abre el modo Mapa. Si hay CRS proyectado y conversión resolubles, revisa la ubicación, el giro y el nivel de confianza detectados.',
        'Si solo existe latitud/longitud en IfcSite, trata el resultado como aproximado y compáralo con el control conocido del proyecto.',
        'Si no hay georreferencia útil, coloca el modelo manualmente e identifica esa posición como aportada por el usuario, no como topográfica.',
        'Activa terreno y entorno capa por capa; verifica eje de calle, huella, altura y elementos cercanos.',
        'Mantén las atribuciones visibles en capturas, informes y presentaciones para clientes.',
      ]},
      { type: 'h2', text: 'La promesa visual y su límite' },
      {
        type: 'image',
        src: 'blog/images/ifc-3d-map-conceptual-editorial.jpg',
        alt: 'Ilustración editorial conceptual de un edificio BIM translúcido alineado sobre una cuadrícula urbana mediterránea al atardecer',
        caption: 'Ilustración editorial conceptual generada para este artículo. Comunica la idea IFC + GIS; no es una captura del producto, un levantamiento ni una representación del Pabellón Ciutadella.',
        width: 1600,
        height: 900,
        credit: 'IFC Viewer Online · ilustración conceptual generada con IA',
      },
      { type: 'pull-quote', text: 'Un mapa 3D convincente es útil. La fuente de coordenadas, el nivel de confianza y un modelo reproducible son lo que le da autoridad.', cite: 'IFC Viewer Online' },
      { type: 'p', text: ['Si necesitas realidad medida junto al modelo, continúa con ', { text: 'IFC + nube de puntos Scan-to-BIM', to: 'ifc-nube-de-puntos-scan-to-bim-navegador' }, '. Para evidencia temporal de obra, consulta ', { text: 'IFC + vídeo sobre terreno 3D', to: 'ifc-video-terreno-3d-seguimiento-obra' }, '.'] },
    ],
  },
...
export const BLOG_POSTS_FR: BlogPost[] = [

  {
    ...
    seoDescription: 'Votre client vient de vous envoyer un IFC de 200 Mo. Pas de Revit, pas de Navisworks. Comment l’ouvrir, l’inspecter et le valider dans le navigateur.',
    date: '2026-06-01',
    readTimeMin: 5,
